  ...
  <div class="divBox">
    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="几人团" prop="people" min-width="100" align="center" />
        <el-table-column label="几人参加" prop="countPeople" min-width="100" align="center" />
        <el-table-column prop="stopTime" label="结束时间" min-width="130" align="center" />
        <el-table-column label="拼团状态" min-width="150" align="center">
          <template slot-scope="scope">
