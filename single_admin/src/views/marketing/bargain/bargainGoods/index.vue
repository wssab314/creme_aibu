    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        ...
        <router-link :to="{ path: '/marketing/bargain/creatBargain' }">
          <el-button  type="primary" class="mr10" v-hasPermi="['admin:bargain:save']"
            >添加砍价商品</el-button
          >
        </router-link>
        <el-button  class="mr10" @click="exportList" v-hasPermi="['admin:export:excel:bargain']"
          >导出</el-button
        >
      </div>
      <el-table
      ...
      >
        ...
        <el-table-column label="砍价价格" prop="price" min-width="100" align="center" />
        <el-table-column label="最低价" prop="minPrice" min-width="100" align="center" />
        <el-table-column label="参与人数" prop="countPeopleAll" min-width="100" align="center" />
        <el-table-column label="帮忙砍价人数" prop="countPeopleHelp" min-width="100" align="center" />
        <el-table-column label="砍价成功人数" prop="countPeopleSuccess" min-width="100" align="center" />
        <el-table-column label="限量" min-width="100" prop="quotaShow" align="center" />
        <el-table-column label="限量剩余" prop="surplusQuota" min-width="100" align="center" />
        ...
        <el-table-column label="操作" min-width="130" fixed="right" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              class="mr10"
              v-hasPermi="['admin:bargain:delete']"
              >删除</el-button
            >
          </template>
        </el-table-column>
