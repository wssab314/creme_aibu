<template>
  <el-form :model="formValidate" :rules="rules" ref="formValidate" label-width="100px" class="demo-formValidate"
    v-loading="loading">
    ...
    <el-form-item label="评价图片：">
      <div class="acea-row">
        <div v-for="(item, index) in pics" :key="index" class="pictrue" draggable="false"
