    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        ...
        <div class="acea-row">
          ...
          <el-button @click="handleDeleteAll" v-hasPermi="['admin:product:rule:delete']">批量删除</el-button>
        </div>
      </div>
      <el-table ref="table" v-loading="listLoading" :data="tableData.data" style="width: 100%" size="mini"
        ...
        <el-table-column label="操作" min-width="120" fixed="right" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="handleEdit(scope.row)" class="mr10"
