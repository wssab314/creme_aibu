...
<script>
	...
	export default {
		...
		computed: {
				...
				return [{
					...
					},
					{
						'background': this.listStyle == 1 ?
							this.dataConfig.itemBgColor.color[0].item : this.listStyle == 3 ?
							`linear-gradient(180deg,${this.dataConfig.btnColor.color[0].item}, ${this.dataConfig.btnColor.color[1].item})` :
							'',
					},
				];
			},
			...
			btnColorStyle() {
				return [{
					'background': `linear-gradient(90deg,${this.dataConfig.btnColor.color[0].item}, ${this.dataConfig.btnColor.color[1].item})`,
				}, ];
			},
			//展示数量
			limit() {
