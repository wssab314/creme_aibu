    ...
    public Integer getCountByScore(Integer productId, String type) {
        ...
        switch (type) {
            ...
            case ProductConstants.PRODUCT_REPLY_TYPE_GOOD:
                lqw.eq(StoreProductReply::getServiceScore, 5);
                break;
            case ProductConstants.PRODUCT_REPLY_TYPE_MEDIUM:
                lqw.and(i -> i.lt(StoreProductReply::getServiceScore, 5).gt(StoreProductReply::getServiceScore, 1));
                break;
            case ProductConstants.PRODUCT_REPLY_TYPE_POOR:
                lqw.eq(StoreProductReply::getServiceScore, 1);
                break;
        }
